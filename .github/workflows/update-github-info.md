...
7. When there are meaningful changes, use the `create-pull-request` safe-output tool to open a pull request containing the update for Mona to review. The pull request should explain the sources used and the changes made. Do not write directly to `main`.
